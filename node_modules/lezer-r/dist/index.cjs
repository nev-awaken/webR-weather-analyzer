...
const rHighlight = highlight.styleTags({
  "repeat while for if else return break next in": highlight.tags.controlKeyword,
  "Logical!": highlight.tags.bool,
  function: highlight.tags.definitionKeyword,
  "FunctionCall/Identifier FunctionCall/String": highlight.tags.function(highlight.tags.variableName),
  "NamedArg!": highlight.tags.function(highlight.tags.attributeName),
  Comment: highlight.tags.lineComment,
  "Numeric Integer Complex Inf": highlight.tags.number,
  "SpecialConstant!": highlight.tags.literal,
  String: highlight.tags.string,
  "ArithOp MatrixOp": highlight.tags.arithmeticOperator,
  BitOp: highlight.tags.bitwiseOperator,
  CompareOp: highlight.tags.compareOperator,
  "ExtractionOp NamespaceOp": highlight.tags.operator,
  AssignmentOperator: highlight.tags.definitionOperator,
...
const spec_Identifier = {__proto__:null,TRUE:12, T:14, FALSE:18, F:20, NULL:30, NA:34, Inf:38, NaN:42, function:46, "...":50, return:60, break:64, next:68, if:80, else:82, repeat:86, while:90, for:94, in:96};
